...
//      display  loadcard
    ...
    private fun loadCards(){
        ...
        myModelList.add(
            MyModel(
                "ประวัติวัดเจดีย์",
                "วัดเจดีย์หรือวัดไอ้ไข่ ตั้งอยู่ที่ หมู่ 7 ตำบลฉลอง อำเภอสิชล จังหวัดนครศรีธรรมราช เคยเป็นวัดร้างที่เชื่อกันว่าสร้างมาเป็นเวลานับ1000 ปี มีเพียงเจดีย์โบราณเก่ารกร้างอยู่ตรงบริเวณที่กำลังสร้างโบสถ์ในปัจจุบัน\n",
                R.drawable.h1)
        )
        myModelList.add(
            MyModel(
